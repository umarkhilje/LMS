...
<div class="container">
	...
	<div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 30px">
		...
		<div class="alert alert-success alert-dismissable">
			...
			<?php } ?>
			<p class="page-header" style="text-align: center;color:#FFFFFF;font-weight:bolder">ADD ADMIN</p>

			<div class="container form">
				<form class="form-horizontal" role="form" method="post" action="adduser.php" enctype="multipart/form-data">
				<div class="form-group">
						<label for="Name" class="col-sm-2 control-label" style="text-align:center;color:white;">Full Name</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="name" placeholder="Enter Full Name" id="name" required>
						</div>		
					</div>
					<div class="form-group">
						<label for="Username" class="col-sm-2 control-label" style="text-align:center;color:white;">Username</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="Password" class="col-sm-2 control-label" style="text-align:center;color:white;">Confirm Password</label>
						<div class="col-sm-10">
