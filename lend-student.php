...
if(isset($_POST['submit'])){
	...
	$sql = "INSERT INTO borrow(memberName, reg_no, bookName, borrowDate, returnDate) values('$name', '$number', '$bn', '$bdate', '$due')";
...
<div class="container">
	...
	<div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 30px">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <?php } ?>
			<p class="page-header" style="text-align: center;color:#FFFFFF;font-weight:bolder;">LEND BOOK</p>

			<div class="container form">
				<form class="form-horizontal" role="form" action="lend-student.php" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label for="Book Title" class="col-sm-2 control-label" style="text-align:center;color:white;">BOOK TITLE</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="Book Title" class="col-sm-2 control-label" style="text-align:center;color:white;">MEMBER NAME</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="member" id="bookTitle" value="<?php echo $name; ?>">
						</div>		
					</div>
					<div class="form-group">
						<label for="Member Card ID" class="col-sm-2 control-label" style="text-align:center;color:white;">Reg NO</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="matric" value="<?php echo $number; ?>">
						</div>		
					</div>
					<div class="form-group">
						<label for="Borrow Date" class="col-sm-2 control-label" style="text-align:center;color:white;">BORROW DATE</label>
						<div class="col-sm-10">
             			 <input type="date" class="form-control" name="borrowDate" id="brand">
						</div>		
					</div>
					<div class="form-group">
						<label for="Password" class="col-sm-2 control-label" style="text-align:center;color:white;">RETURN DATE</label>
