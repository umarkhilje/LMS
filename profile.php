 ...
 <div class="container " style="margin-top: 100px">
 		<div class="row col-lg-12 col-lg-offset-1" style="margin-top: 30px;margin-bottom: 40px">
            <div class="col-lg-6 col-md-6">
            	<h2 style="color:#FFFFFF;font-weight:bolder;">Student Profile</h2>
            </div>
         </div>
            <div class="jumbotron">
               <table class="table table-bordered" id="table">
                  ...
                  <tbody> 
                    ...
                    <tr> 
                     ...
                     <td style="text-align:center;color:white;">Reg No : </td>
                    ...
                    <tr>
                     ...
                     <td style="text-align:center;color:white;">Department : </td>
