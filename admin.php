	...
	<div class="container">
        ...
        <div class="alert alert-success alert-dismissable">
		  ...
		  <div class="panel-heading heading">
		  	<div class="row">
		  		<h3 class="center-block" style="text-align:center;color:white;">Published Announcements</h3>
			</div>
		  </div>
     ...
     <?php }
           ?>
			...
			<div class="panel panel-default">
				  <div class="panel-heading heading">
				    <h2 class="panel-title center-block" style="text-align:center;color:white;">Publish New Announcements</h2>
				  </div>
